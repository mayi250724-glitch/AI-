...
import { X, Trash2, Clock, FileText, ArrowRight, Calendar, Loader2, Cloud } from 'lucide-react';
      ...
      <div className="relative bg-[#121212] w-full max-w-3xl h-[80vh] border border-[#262626] rounded-2xl shadow-2xl flex flex-col overflow-hidden">
        ...
        <div className="h-16 border-b border-[#262626] flex items-center justify-between px-6 bg-[#171717]">
            <div className="flex items-center gap-3">
                ...
                {isBackend && (
                    <span className="text-xs bg-green-900/30 text-green-400 px-2 py-0.5 rounded border border-green-500/30 flex items-center gap-1">
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-4">
            {isLoading ? (
                <div className="h-full flex flex-col items-center justify-center gap-4">
                    ...
                    <span className="text-gray-500 text-xs">Loading projects...</span>
                </div>
            ) : projects.length === 0 ? (
